#ifndef _REVERSE_ITERATOR_HPPP_
#define _REVERSE_ITERATOR_HPPP_
...
namespace TinySTL{
	...
	public:
		...
		friend bool operator == (const reverse_iterator_t<Iterator2>& lhs,
								const reverse_iterator_t<Iterator2>& rhs);
		template <class Iterator2>
		friend bool operator != (const reverse_iterator_t<Iterator2>& lhs,
								const reverse_iterator_t<Iterator2>& rhs);
		template <class Iterator2>
		...
		friend reverse_iterator_t<Iterator> operator + (
			typename reverse_iterator_t<Iterator2>::difference_type n,
			const reverse_iterator_t<Iterator2>& rev_it);
		template <class Iterator2>
		friend typename reverse_iterator_t<Iterator2>::difference_type operator- (
			const reverse_iterator_t<Iterator2>& lhs,
			const reverse_iterator_t<Iterator2>& rhs);
