...
namespace TinySTL{
	...
	public:
		...
		friend bool operator== (const queue<U, Container2>& lhs, const queue<U, Container2>& rhs);
		template <class U, class Container2>
		friend bool operator!= (const queue<U, Container2>& lhs, const queue<U, Container2>& rhs);
		template <class U, class Container2>
		friend void swap(queue<U, Container2>& x, queue<U, Container2>& y);
	};
	...
	public:
		template <class U, class Container2, class Compare2>
		friend void swap(priority_queue<U, Container2, Compare2>& x, priority_queue<U, Container2, Compare2>& y);
	};
