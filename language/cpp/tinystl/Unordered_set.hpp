...
namespace TinySTL{
	...
	namespace Detail{
		...
		private:
			template<class Key2, class ListIterator2, class Hash2, class KeyEqual2, class Allocator2>
			friend bool operator ==(const ust_iterator<Key2, ListIterator2, Hash2, KeyEqual2, Allocator2>& lhs,
				const ust_iterator<Key2, ListIterator2, Hash2, KeyEqual2, Allocator2>& rhs);
			template<class Key2, class ListIterator2, class Hash2, class KeyEqual2, class Allocator2>
			friend bool operator !=(const ust_iterator<Key2, ListIterator2, Hash2, KeyEqual2, Allocator2>& lhs,
				const ust_iterator<Key2, ListIterator2, Hash2, KeyEqual2, Allocator2>& rhs);
		};
	...
	class Unordered_set{
	private:
		template<class Key2, class ListIterator, class Hash2, class KeyEqual2, class Allocator2>
...
#define PRIME_LIST_SIZE 28
	...
	public:
		template<class Key2, class Hash2, class KeyEqual2, class Allocator2>
		friend void swap(Unordered_set<Key2, Hash2, KeyEqual2, Allocator2>& lhs,
			Unordered_set<Key2, Hash2, KeyEqual2, Allocator2>& rhs);
	};
