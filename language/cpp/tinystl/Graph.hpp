...
namespace TinySTL{
	namespace Detail{
		...
		public:
			template<class Index2, class Value2, class EqualFunc2>
			friend bool operator ==(const inner_iterator<Index2, Value2, EqualFunc2>& lhs,
				const inner_iterator<Index2, Value2, EqualFunc2>& rhs);
			template<class Index2, class Value2, class EqualFunc2>
		...
		public:
			template<class Index2, class Value2, class EqualFunc2>
			friend bool operator ==(const outter_iterator<Index2, Value2, EqualFunc2>& lhs,
				const outter_iterator<Index2, Value2, EqualFunc2>& rhs);
			template<class Index2, class Value2, class EqualFunc2>
